...
shapeOr  		: shapeEachOf (KW_OR shapeEachOf)* ;
inlineShapeOr   : inlineShapeEachOf (KW_OR inlineShapeEachOf)* ;
shapeEachOf 	: shapeAnd (KW_SEO shapeAnd)* ;
inlineShapeEachOf: inlineShapeAnd (KW_SEO inlineShapeAnd)* ;
